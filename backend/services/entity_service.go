...
func (s *EntityService) GetEntity(id int) (*database.Entity, error) {
...
func (s *EntityService) SearchEntities(query string, typeSlug string) ([]database.Entity, error) {
	var sqlQuery string
	var args []interface{}
...
func (s *EntityService) GetRelationships(entityID int) ([]database.Relationship, error) {
	...
	var relationships []database.Relationship
	for rows.Next() {
		var r database.Relationship
...
func (s *EntityService) GetAllRelationships() ([]database.Relationship, error) {
...
func (s *EntityService) CreateEntity(e database.Entity) (int, error) {
...
func (s *EntityService) UpdateEntity(e database.Entity) error {
...
func (s *EntityService) SearchEntitiesWithOptions(query string, types []string, source string) ([]database.Entity, error) {
	var args []interface{}
	var sqlQuery string
...
func (s *EntityService) GetAllEntities() ([]database.Entity, error) {
...
func (s *EntityService) GetRandomEntity() (*database.Entity, error) {
...
func (s *EntityService) GetExtendedStats() (*database.DashboardStats, error) {
	return s.db.GetExtendedStats()
}

func (s *EntityService) GetTopHubs(limit int) ([]database.Entity, error) {
	query := `
...
func (s *EntityService) GetMarkedEntities() ([]database.Entity, error) {
